<template>
  <div class="default-layout-sidebar">
    <div class="default-layout-sidebar-header">
      <div class="default-layout-sidebar-header-logo">
        <svg
          width="142"
          height="30"
          viewBox="0 0 142 30"
        ...
        >
          <rect width="142" height="30" fill="url(#pattern0)" />
          <defs>
            <pattern
              id="pattern0"
            ...
            >
              <use
                ...
                transform="scale(0.00352113 0.016129)"
              />
            </pattern>
            <image
              id="image0_1_48"
        ...
        <li>
          <router-link to="/statistics">
            <i>
              ...
              >
                <path
                  d="M6.2192 0.856C2.7856 0.856 0 3.64 0 7.0752C0 10.5104 2.784 13.296 6.2192 13.296C9.6544 13.296 12.4384 10.512 12.4384 7.0752H6.2192V0.856V0.856ZM14 6.3632C14 4.6464 13.304 3.0912 12.1792 1.9664L7.7808 6.3632H14ZM7.0064 0V6.2176L11.4032 1.8208C10.1888 0.6064 8.5968 0 7.0064 0V0Z"
                  fill="#DBDDE0"
                />
              </svg>
            </i>
